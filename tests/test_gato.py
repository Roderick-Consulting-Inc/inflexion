...
"""End-to-end test: examples/gato.infl.
...
EXAMPLE = REPO_ROOT / "examples" / "gato.infl"
SOURCE = EXAMPLE.read_text(encoding="utf-8")


def test_gato_simple_line() -> None:
