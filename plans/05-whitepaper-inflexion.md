...
![Inflexión's six grammatical-semantic mappings — two-column flow: Spanish grammatical feature on the left (Number, Mood, Aspect, Ser/Estar, Clitic ordering, Diminutive/Augmentative) → programming semantic on the right (Scalar/Collection, Eager/Deferred/Effect, Eager/Lazy, Immutable/Mutable, Argument routing, Numeric & cost scaling).](https://diagrams.roderickc.com/api/v1/apps/www/diagrams/inflexion-mappings.svg)
...
### 3.1 Number → scalar vs collection
...
### 3.5 Clitic ordering → argument shuffling
